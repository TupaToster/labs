...
\begin{figure}[h]
    \center{\includegraphics[width=\textwidth]{xi_nu_low_freq_linearized.png}k}
...
\begin{figure}[h]
    \center{\includegraphics[width=0.7\textwidth]{L_nu}}
...
\begin{figure}[h]
    ...
    \center{\includegraphics[width=\textwidth]{low_freq_ratio}}
...
\begin{figure}[h]
    \center{\includegraphics[width=\textwidth]{mid_freq_ratio}}
    \caption{Отношение полей - среднечастотный диапазон}\label{fig:mid_freq_ratio}
    \center{\includegraphics[width=\textwidth]{high_freq_ratio}}
...
\begin{figure}[h]
    \center{\includegraphics[width=\textwidth]{reduction_ratio}}
